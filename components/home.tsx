        ...
        <div className={Style.mainContainer}>
            ...
            <div className={Style.cardContainer}>
                ...
                <div className={Style.card}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('vreGhgI254d')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('ejli3HDKJejfh')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('pyjfyRMdI')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('DLdjrhLGjh')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('kdkYBJFDyvhk')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('tdYTGLTjkdt')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('khugbjGUJBLfkj')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('tglfFRYBJM')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('glktyRBKGF')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('unkfhRVKkgf')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
                  ...
                  {/* Card */}
                  <div className={Style.card}>
                    <Link href={`/watch/${encodeURIComponent('hkRjklfUUklziu')}`}>
                    <Image src='/assets/images/coverImage.jpg' className={Style.coverImage} width={312} height={180} alt='' priority />
                    <div className={`${Style.flex} ${Style.videoDetails}`}>
                        <Image className={Style.channel} src='/assets/images/person.jpg' width={50} height={50} alt='' priority />
                        <div className={Style.details}>
